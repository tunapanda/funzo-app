...
var cordovaCfgXml = fs.readFileSync(
  "ember-cordova/cordova/TEMPLATE-config.xml"
);
...
cordovaCfg
  .get("/n:widget/n:name", { n: "http://www.w3.org/ns/widgets" })
  .text(env.APP.name);
cordovaCfg
  .get("/n:widget/n:description", { n: "http://www.w3.org/ns/widgets" })
  .text(env.APP.description);
var author = cordovaCfg.get("/n:widget/n:author", {
  n: "http://www.w3.org/ns/widgets"
});
...
module.exports = function(defaults) {
  ...
  app.import("vendor/zip/zip-fs.js");
  app.import("vendor/zip/zip-ext.js");
